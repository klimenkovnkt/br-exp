...
function loop_2_blocksLoopBegin(loop_2_blocksLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    loop_2_blocks.forEach(function() {
...
function quest_1RoutineBegin(snapshot) {
  return async function () {
    ...
    quest_1Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function pic_1RoutineBegin(snapshot) {
  return async function () {
    ...
    pic_1Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function ans_quest_1RoutineBegin(snapshot) {
  return async function () {
    ...
    ans_quest_1Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function pic2RoutineBegin(snapshot) {
  return async function () {
    ...
    pic2Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function final_textRoutineBegin(snapshot) {
  return async function () {
    ...
    final_textComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
